...
import uk.gov.hmcts.reform.finrem.caseorchestration.handler.AmendCaseConsentedAboutToStartHandler;
...
public class AmendCaseConsentedAboutToStartHandlerIntegrationTest extends BaseTest {
    ...
    @Autowired
    private AmendCaseConsentedAboutToStartHandler amendCaseConsentedAboutToStartHandler;

    @Test
    public void shouldSetToDefault() throws Exception{

        GenericAboutToStartOrSubmitCallbackResponse<Map<String, Object>> response
            = amendCaseConsentedAboutToStartHandler.handle(CallbackRequest.builder()
