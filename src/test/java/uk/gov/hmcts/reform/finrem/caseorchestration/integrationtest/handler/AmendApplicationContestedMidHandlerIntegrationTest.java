...
import uk.gov.hmcts.reform.finrem.caseorchestration.handler.AmendApplicationContestedMidHandler;
...
public class AmendApplicationContestedMidHandlerIntegrationTest extends BaseTest {
    ...
    @Autowired
    private AmendApplicationContestedMidHandler amendApplicationContestedMidHandler;

    @Test
    public void shouldSetToDefault() throws Exception{

        GenericAboutToStartOrSubmitCallbackResponse<Map<String, Object>> response
            = amendApplicationContestedMidHandler.handle(CallbackRequest.builder()
