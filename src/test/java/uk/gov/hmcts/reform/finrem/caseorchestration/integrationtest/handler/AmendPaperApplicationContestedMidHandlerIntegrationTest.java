...
import uk.gov.hmcts.reform.finrem.caseorchestration.handler.AmendPaperApplicationContestedMidHandler;
...
public class AmendPaperApplicationContestedMidHandlerIntegrationTest extends BaseTest {
    ...
    @Autowired
    private AmendPaperApplicationContestedMidHandler amendPaperApplicationContestedMidHandler;

    @Test
    public void shouldSetToDefault() throws Exception{

        GenericAboutToStartOrSubmitCallbackResponse<Map<String, Object>> response
            = amendPaperApplicationContestedMidHandler.handle(CallbackRequest.builder()
