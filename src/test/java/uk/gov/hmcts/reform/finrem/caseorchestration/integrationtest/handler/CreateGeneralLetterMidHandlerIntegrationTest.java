...
import uk.gov.hmcts.reform.finrem.caseorchestration.handler.CreateGeneralLetterMidHandler;
...
public class CreateGeneralLetterMidHandlerIntegrationTest extends BaseTest {
    ...
    @Autowired
    private CreateGeneralLetterMidHandler createGeneralLetterMidHandler;
    ...
    public void shouldSetDefaultValues() throws Exception {
        ...
        GenericAboutToStartOrSubmitCallbackResponse<FinremCaseData> response
            = createGeneralLetterMidHandler.handle(FinremCallbackRequest.builder()
