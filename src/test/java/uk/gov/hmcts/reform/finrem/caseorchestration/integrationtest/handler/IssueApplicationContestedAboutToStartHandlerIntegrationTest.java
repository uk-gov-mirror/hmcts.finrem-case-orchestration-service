...
import uk.gov.hmcts.reform.finrem.caseorchestration.handler.IssueApplicationContestedAboutToStartHandler;
...
public class IssueApplicationContestedAboutToStartHandlerIntegrationTest extends BaseTest {
    ...
    @Autowired
    private IssueApplicationContestedAboutToStartHandler issueApplicationContestedAboutToStartHandler;

    @Test
    public void shouldSetDefaultValues() throws Exception{

        GenericAboutToStartOrSubmitCallbackResponse<FinremCaseData> response
            = issueApplicationContestedAboutToStartHandler.handle(FinremCallbackRequest.builder()
