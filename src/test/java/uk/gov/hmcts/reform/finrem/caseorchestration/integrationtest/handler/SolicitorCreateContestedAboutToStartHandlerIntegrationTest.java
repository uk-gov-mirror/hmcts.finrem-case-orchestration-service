...
import uk.gov.hmcts.reform.finrem.caseorchestration.handler.SolicitorCreateContestedAboutToStartHandler;
...
public class SolicitorCreateContestedAboutToStartHandlerIntegrationTest extends BaseTest {
    ...
    @Autowired
    private SolicitorCreateContestedAboutToStartHandler solicitorCreateContestedAboutToStartHandler;

    @Test
    public void shouldSetToDefault() throws Exception{

        GenericAboutToStartOrSubmitCallbackResponse<Map<String, Object>> response
            = solicitorCreateContestedAboutToStartHandler.handle(CallbackRequest.builder()
