...
import uk.gov.hmcts.reform.finrem.caseorchestration.handler.AmendCaseContestedAboutToStartHandler;
...
public class AmendCaseContestedAboutToStartHandlerIntegrationTest extends BaseTest {
    ...
    @Autowired
    private AmendCaseContestedAboutToStartHandler amendCaseContestedAboutToStartHandler;

    @Test
    public void shouldSetToDefault() throws Exception{

        GenericAboutToStartOrSubmitCallbackResponse<Map<String, Object>> response
            = amendCaseContestedAboutToStartHandler.handle(CallbackRequest.builder()
