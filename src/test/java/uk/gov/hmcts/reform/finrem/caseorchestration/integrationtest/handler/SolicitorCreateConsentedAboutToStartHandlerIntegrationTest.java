...
import uk.gov.hmcts.reform.finrem.caseorchestration.handler.SolicitorCreateConsentedAboutToStartHandler;
...
public class SolicitorCreateConsentedAboutToStartHandlerIntegrationTest extends BaseTest {
    ...
    @Autowired
    private SolicitorCreateConsentedAboutToStartHandler solicitorCreateConsentedAboutToStartHandler;

    @Test
    public void shouldSetToDefault() throws Exception{

        GenericAboutToStartOrSubmitCallbackResponse<Map<String, Object>> response
            = solicitorCreateConsentedAboutToStartHandler.handle(CallbackRequest.builder()
            .eventId("SomeEventId")
